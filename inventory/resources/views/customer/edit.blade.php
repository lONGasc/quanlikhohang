        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('supplier.update',$customer->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="dropify" type="file" name="image" id="image" class="form-control" data-default-file ="{{url('uploads/supplier/'.$customer->image)}}">
                            </div>
                            @error('image')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
